REPORT z_abptrainshu_exer54_ans.
*****************************************************************************
*Title: Answer to Exer 54
*Author: Whoever placed it in the answer folder. Shu for comments
*Date: 04/23/2019
*Purpose: This program uses a abstract class and factory design pattern to
*make a calculator. Views can be choosen as ALV grid or write statments.
******************************************************************************
